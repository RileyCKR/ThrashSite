...
define( 'NOTIFIER_THEME_NAME', 'Avenue' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'Avenue' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://wp-avenue.themesector.com/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
